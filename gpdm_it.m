function [X, theta, thetad, w, K, invK] = gpdm_it( Y, q )
% GPDM_IT Computes the GPDM for give data matrix. Returns the GPs for latent
% mapping(K) and dynamics in latent space (K_d)
% Y - data
% q - latent space dimensionality

addpath(genpath('../gpdm_example'))
